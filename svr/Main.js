...
// console.log( chatLib )  { EVENT_TYPE: {LOGIN, LOGOUT, SPEAK, LIST_USER}, PORT, HOST,analyzeMessageData, getMsgFirstDataValue, getMsgSecondDataValue: }
...
/**         
 * SimpleMap的prototype属性   SimpleMap的this指向问题
 * CircleList的prototype属性   CircleList的this指向问题
 */
var zTool = require("./zTool");
// console.log( zTool )  ///-> { SimpleMap: [Function], CircleList: [Function] }  为 function  需要 new
// console.log( new zTool.CircleList() ) 

var onlineUserMap = new zTool.SimpleMap();   //->  onlineUserMap: { map: {}, mapSize: 0 }
var historyContent = new zTool.CircleList(100)//-> historyContent: { maxSize: 10, list: [], index: null }   maxSize 为 传入的参数 或者 10
var connCounter = 1;
var uid = null;
...
wss.on('connection', function(conn) {
    ...
    conn.on('message', function(message) {
        // console.log( message ){"EVENT":"LOGIN","values":["sdfg"]}{"EVENT":"LIST_USER","values":["sdfg"]}{"EVENT":"LIST_HISTORY","values":["sdfg"]}
        var mData = chatLib.analyzeMessageData(message); ////JSON.parse 解析 message
